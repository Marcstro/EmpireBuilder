...
public class CircleSearch {
    ...
    public List<int[]> getPositionsAroundTargetInCircleExcludingCenter(int x, int y, int radius) {
    ...
    // DOES check for border edges
    public List<int[]> getAllPositionsAroundTargetInCircleIncludingCenter(int centerX, int centerY, int radius) {
